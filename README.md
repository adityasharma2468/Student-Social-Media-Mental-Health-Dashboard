...
> impact of Social Media usage on Student 
> Mental Health | 5,000 Students Dataset
...
| 📱 Avg Daily Usage | 5.08 hrs |
| 🧠 Mental Health Score | 6.23/10 |
| 😟 High Stress Students | 32% |
| 🏃 Avg Physical Activity | 1.75 hrs |
| 😴 Avg Sleep Hours | 6.63 hrs |
| 📚 Avg Study Hours | 3.01 hrs |

## 📊 Visuals Included

| Visual | Description |
|--------|-------------|
| 🃏 KPI Cards | 7 Key Metrics |
| 🍕 Pie Chart | Purpose of Use |
| 📈 Line Chart | MH Score by Stress Level |
| 📊 Bar Chart | Most Used Platform |
| 📋 Table | Platform vs MH Score |
| 🍩 Donut Chart | Gender Distribution |
| 📊 Bar Chart | Academic Level |
| 🎛️ Slicers | Age & Gender Filter |

## 🔑 Key Insights

## 📱 Platform vs Mental Health Score

| Platform | Avg Usage | MH Score |
|----------|-----------|----------|
| LINE | 3.31 hrs | 8.02 ⭐ |
| VKontakte | 4.18 hrs | 7.00 |
| WeChat | 4.96 hrs | 6.49 |
| LinkedIn | 4.83 hrs | 6.48 |
| Facebook | 4.93 hrs | 6.40 |
| **Total** | **5.08 hrs** | **6.23** |

## 🧠 Mental Health by Stress Level

| Stress Level | MH Score |
|-------------|---------|
| 🟢 Low | 7.8 |
| 🟡 Medium | 7.1 |
| 🟠 High | 6.0 |
